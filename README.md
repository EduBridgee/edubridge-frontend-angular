...
* **Who (¿Quiénes?):** Estudiantes universitarios con necesidades de seguimiento y docentes que gestionan múltiples cursos.
...
* **When (¿Cuándo?):** Durante todo el ciclo académico, con énfasis en periodos de riesgo de deserción.
...
* **Objetivos Específicos:**
    ...
    * Facilitar canales de comunicación directa entre tutores y estudiantes mediante herramientas de colaboración en tiempo real.

---

## 4. Desarrollo de Software: Frontend

El frontend de **EduBridge** ha sido diseñado bajo un enfoque de **User-Centered Design (UCD)**, priorizando la accesibilidad y la visualización de datos complejos.

### 4.1. Tecnologías Utilizadas
* **Framework Principal:** React.js / TypeScript.
* **Estilos:** CSS3 / Sass (Metodología BEM).
* **Gestión de Estado:** Context API / Redux para persistencia de datos de usuario.
* **Visualización de Datos:** Chart.js o D3.js para dashboards de KPIs.
* **Comunicación Real-Time:** Socket.io para el sistema de tutorías y alertas.
* **Integraciones:** Jitsi Meet API (Videollamadas) y Excalidraw (Pizarra virtual).
